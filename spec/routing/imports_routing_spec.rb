...
describe ImportsController do
  describe "routing" do
    ...
    it "routes to #edit" do
      get("/imports/1/edit").should route_to("imports#edit", :id => "1")
    end
    ...
    it "routes to #update" do
      put("/imports/1").should route_to("imports#update", :id => "1")
    end

    it "routes to #destroy" do
      delete("/imports/1").should route_to("imports#destroy", :id => "1")
    end
