...
after cloning this repo run
  ...
  git clone git@github.com:dwaynemac/importer.git

  mv importer your-app-name
  cd your-app-name

  rm -rf .git
  git init .
  git add .
  git commit -am "cloned importer"

  find ./* -type f -exec sed -i 's/Importer/YourAppName/g' {} \;
  find ./* -type f -exec sed -i 's/importer/your-app-name/g' {} \;
